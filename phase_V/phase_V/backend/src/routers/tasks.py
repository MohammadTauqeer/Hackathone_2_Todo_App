...
from src.services.event_service import send_event
...
def create_task(
    ...
    # Send event to Redis Stream (Phase V: Event-Driven Architecture)
    task_response = TaskResponse.model_validate(task)
    send_event("TASK_CREATED", task_response.model_dump())
