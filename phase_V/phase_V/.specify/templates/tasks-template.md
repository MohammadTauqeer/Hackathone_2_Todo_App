...
- [ ] T002 Initialize [language] project with [framework] dependencies using AI-generated code
...
Task: "Contract test for [endpoint] in tests/contract/test_[name].py" (generated via AI)
Task: "Integration test for [user journey] in tests/integration/test_[name].py" (generated via AI)

# Launch all models for User Story 1 together:
Task: "Create [Entity1] model in src/models/[entity1].py" (AI-generated)
Task: "Create [Entity2] model in src/models/[entity2].py" (AI-generated)
```
