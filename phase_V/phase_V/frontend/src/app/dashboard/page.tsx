          ...
          <div className="mb-8 flex flex-col sm:flex-row items-stretch sm:items-center gap-4 bg-white/90 p-4 rounded-xl border border-purple-50 shadow-lg backdrop-blur-sm">
            ...
            <div className="hidden sm:flex gap-2">
               <Button 
                variant="ghost" 
                size="sm" 
                className={`font-medium transition-colors ${filter === 'all' ? 'text-purple-700 bg-purple-50' : 'text-slate-600 hover:text-slate-900'}`}
               ...
               <Button 
                variant="ghost" 
                size="sm" 
                className={`font-medium transition-colors ${filter === 'active' ? 'text-purple-700 bg-purple-50' : 'text-slate-600 hover:text-slate-900'}`}
               ...
               <Button 
                variant="ghost" 
                size="sm" 
                className={`font-medium transition-colors ${filter === 'completed' ? 'text-purple-700 bg-purple-50' : 'text-slate-600 hover:text-slate-900'}`}
